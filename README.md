...
Arrays of protein_haplotypes and cds_haplotypes are returned for a given transcript. The default haplotype record includes:
...
* **diffs**: differences between the reference and this haplotype - variant descriptions
...
* **name**": a human readable name for the haplotype (sequence id + REF or change description)
